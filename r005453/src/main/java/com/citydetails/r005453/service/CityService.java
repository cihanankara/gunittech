...
public class CityService {
	...
	@RequestMapping(value = "/rest/city/getcityJSON/{name}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> getCityJSON(@PathVariable String name) {
		return City.getCitiesJSON(name);
	}

	@RequestMapping(value = "/rest/city/getcityXML/{name}", method = RequestMethod.GET, produces = MediaType.APPLICATION_XML_VALUE)
